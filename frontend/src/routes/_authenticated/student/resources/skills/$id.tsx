...
import { SkillDetailPage } from '@/features/resources/components'

// Component trang chi tiết kỹ năng
...
export const Route = createFileRoute('/_authenticated/student/resources/skills/$id')(
  {
    beforeLoad: ({ location }) => {
