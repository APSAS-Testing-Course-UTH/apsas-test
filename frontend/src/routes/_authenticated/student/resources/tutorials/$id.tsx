...
import { TutorialDetailPage } from '@/features/resources/components'

// Component trang chi tiết hướng dẫn
const TutorialDetailRoute = () => {
  return (
...
export const Route = createFileRoute('/_authenticated/student/resources/tutorials/$id')(
  {
    beforeLoad: ({ location }) => {
