...
describe('GET /api/v1/users - List Users', () => {
  ...
  it('should return paginated users for admin', async () => {
    const response = await fetch(`${baseURL}/api/v1/users?page=0&size=2`, {
      method: 'GET',
      headers: {
  ...
  it('should return second page correctly', async () => {
    const response = await fetch(`${baseURL}/api/v1/users?page=1&size=2`, {
      method: 'GET',
      headers: {
        'Authorization': `Bearer ${mockTokens.admin}`,
        'Content-Type': 'application/json',
  ...
  it('should handle large page numbers', async () => {
    const response = await fetch(`${baseURL}/api/v1/users?page=999&size=10`, {
      method: 'GET',
      headers: {
        'Authorization': `Bearer ${mockTokens.admin}`,
        'Content-Type': 'application/json',
