...
public class SubmissionController {
  ...
  public ResponseEntity<PageResponse<SubmissionResponse>> getAllSubmissions(
    ...
    PageResponse<SubmissionResponse> submissions =
        submissionService.getAllSubmissions(
            userPrincipal.userId(), assignmentId, studentId, status, isInstructor, pageParams.toPageable());
  ...
  public ResponseEntity<SubmissionResponse> createSubmission(
      @Valid @RequestBody CreateSubmissionRequest request, Authentication authentication) {
    UserPrincipal userPrincipal = (UserPrincipal) authentication.getPrincipal();
    SubmissionResponse submission =
  ...
  public ResponseEntity<SubmissionResponse> provideFeedback(
      ...
      @Valid @RequestBody apsas.submission.model.dto.SubmissionFeedbackRequest request) {
